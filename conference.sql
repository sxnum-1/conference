...
insert into CommitteeMember values ('000005','So', 'Bosa');
insert into SponsorCompany values ('lemonsRus','123MainSt', 'Platinum');
insert into SponsorCompany values ('lemonswereus','224MainSt', 'Gold');
insert into SponsorCompany values ('lemonsnowus','125KingSt', 'Bronze');
insert into SponsorCompany values ('no lemons','125QueenSt', 'Silver');
...
insert into SessionEvent values ('MoreToEat', '2019-02-09 08:30:01','2019-02-09 09:30:01','001');
insert into SessionEvent values ('learnedToPlay', '2019-02-10 08:30:01','2019-02-10 09:30:01','300');
insert into SessionEvent values ('MoreToFly', '2019-02-10 10:30:01','2019-02-10 11:30:01','001');
...
insert into Professional(firstName, lastName, email) values ('Abbey', 'Road', '14ar45@queensu.ca');
insert into Professional(firstName, lastName, email) values ('Bob', 'Dylan', 'bd@fl.com');
...
insert into Student(firstName, lastName, email, roomNumber) values ('Joe', 'Bombosa', 'jbombosa@queensu.ca','004');
insert into Student(firstName, lastName, email, roomNumber) values ('Moe', 'Rombosa', 'mRombosa@queensu.ca','002');
insert into Student(firstName, lastName, email, roomNumber) values ('Q', 'A', 'q&a@queensu.ca','003');
insert into Sponsor(firstName, lastName, email, emailsSent, companyName) values ('Toad', 'Stool', 'toadstoll@mushroom.com', 0, 'lemonsRus');
...
insert into Sponsor(firstName, lastName, email, emailsSent, companyName) values ('Dog', 'Goodboy', 'goodboy16@goodboy.ca' , 0, 'lemonsnowus');
insert into Sponsor(firstName, lastName, email, emailsSent, companyName) values ('Bonjour', 'Chat', 'notcat@quebec.ca', 0, 'lemonsnowus');
insert into Sponsor(firstName, lastName, email, emailsSent, companyName) values ('Bonjour', 'Cat', 'cat@quebec.ca', 1, 'no lemons');
insert into JobPostings values ('Cat Flipper','narnia','nevereverland',6.02,'no lemons');
insert into JobPostings values ('Dog Watcher','canada','wonderland',3.14,'lemonsRus');
insert into JobPostings values ('Dog Flipper','heaven','moneybags',99.9,'lemonsRus');
insert into JobPostings values ('Cow Tipper','cows','cow',10.00,'lemonswereus');
insert into JobPostings values ('Wizard','amazons','jungle',0,'lemonswereus');
insert into JobPostings values ('Lizard','hogwarts','professor',1000,'lemonsnowus');
insert into IsMember values ('000003','Program Committee', TRUE);
insert into IsMember values ('000002','Sponsor Committee', FALSE);
insert into IsMember values ('000001','Registration Committee', FALSE);
insert into IsMember values ('000000','Registration Committee', TRUE);
insert into IsMember values ('000005','Sleeping Committee', FALSE);
...
insert into StudentSpeaksFor values (3,'MoreToEat');
...
insert into SponsorSpeaksFor values (3,'MoreToFly');
